...
def create_social_or_404(request, name, card):
    try:
        icons = {
            'VK': '/static/media/icons/vk.png',
            'iTunes': '/static/media/icons/itunes.png',
            'Boom': '/static/media/icons/boom.png',
            'Youtube Music': '/static/media/icons/youtube.png',
            'Yandex Music': '/static/media/icons/yandex.png',
            'Spotify': '/static/media/icons/spotify.png',
            'SoundCloud': '/static/media/icons/soundcloud.png',
            'Deezer': '/static/media/icons/deezer.png',
